...
bin_sha512() {
  case "$OPAM_BIN" in
    ...
    opam-2.2.0-alpha2-x86_64-linux)    echo "df8423ff640c0914d170f274172a77d8dc7a623d5018b1ec959ed905b280ac5f3a90ecab63f09d2b9398e63d8aab4d7da2292b5143dae320ec6efa5bfa4fbd8c";;
