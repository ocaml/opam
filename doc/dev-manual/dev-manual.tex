...
\item Files listed under {\tt bin} are copied to \verb+$bin/+.
\item Files listed under {\tt doc} are copied to \verb+$doc/$NAME/+.
\item Files listed under {\tt toplevel} are copied to \verb+$prefix/toplevel+.
\item Files lister under {\tt stulibs} are copied to \verb+$lib/stublibs/+
