...
external cleanup: unit -> unit = "minUnix_cleanup"
...
external filedescr_of_fd : int -> file_descr = "minUnix_filedescr_of_fd"
...
external in_channel_of_descr : file_descr -> in_channel
                             = "minUnix_inchannel_of_filedescr"
external out_channel_of_descr : file_descr -> out_channel
                              = "minUnix_outchannel_of_filedescr"
external descr_of_in_channel : in_channel -> file_descr
                             = "minUnix_filedescr_of_channel"
