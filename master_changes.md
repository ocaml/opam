...
## Build
  ...
  * Switch to newer version of MCCS (based on newer GLPK) for src_ext [@altgr]

## Infrastructure
  * Release scripts: switch to OCaml 4.10.2 by default, add macos/arm64 builds by default
