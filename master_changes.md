...
## Install
  * [BUG] Fix `opam install --deps-only` using the opam description of the wrong package in some cases [#6543 @kit-ty-kate - fix #6535]
...
### Tests
  ...
  * Add a test showing the use of the wrong opam definition when reinstalling the package given with `--deps-only` [#6543 @kit-ty-kate]
