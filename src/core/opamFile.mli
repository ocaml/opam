...
module Config: sig
  ...
  val create:
    ...
    ?solver:(simple_arg list) ->
    int ->
    ?download_tool:(simple_arg list) ->
    int ->
    t
  ...
  val with_solver: t -> simple_arg list option -> t
  ...
  val dl_tool: t -> simple_arg list option
  ...
  val solver: t -> simple_arg list option
