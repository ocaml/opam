...
val check_solution: state -> switch -> solver_result -> unit
...
val check_availability: ?permissive: bool ->
  state -> switch -> OpamPackage.Set.t -> atom list -> unit
...
val sanitize_atom_list: ?permissive: bool -> state -> switch -> atom list -> atom list
