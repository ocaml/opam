...
val download_package: switch_state -> package ->
...
val extract_package: switch_state -> generic_file option -> package -> unit
...
val build_package:
  switch_state -> generic_file option -> package -> exn option OpamProcess.job
...
val install_package:
  switch_state -> package -> exn option OpamProcess.job

(** Find out if the package source is needed for uninstall *)
val removal_needs_download: switch_state -> package -> bool

(** Remove a package. *)
val remove_package:
  switch_state -> ?keep_build:bool -> ?silent:bool ->
...
val cleanup_package_artefacts: switch_state -> package -> unit
