...
(** [load_opams_from_diff repo diffs rt] incrementally
    ...
    - Updates packages from changed opam files that exist

      @param diffs List of [Patch.operation] representing creations, deletions,
...
(* TODO 6625 doc *)
val load_opams_from_tar_gz: OpamRepositoryRoot.Tar.t -> OpamFile.OPAM.t OpamPackage.Map.t
...
(* TODO 6625 add doc to use carefully because of tar extraction that takes long *)
